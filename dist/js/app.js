(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                ...
                if (document.querySelector(".icon-menu").getAttribute("aria-expanded") === "false") {
                    document.querySelector(".icon-menu").setAttribute("aria-expanded", true);
                    document.querySelector(".icon-menu").setAttribute("aria-label", "закрыть меню");
                } else {
                    document.querySelector(".icon-menu").setAttribute("aria-expanded", false);
                    document.querySelector(".icon-menu").setAttribute("aria-label", "открыть меню");
                }
            }
        }));
    }
    ...
    function Pagination({swiper, extendParams, on, emit}) {
        ...
        function update() {
            ...
            if (swiper.params.loop) current = swiper.params.slidesPerGroup > 1 ? Math.floor(swiper.realIndex / swiper.params.slidesPerGroup) : swiper.realIndex; else if (typeof swiper.snapIndex !== "undefined") current = swiper.snapIndex; else current = swiper.activeIndex || 0;
            ...
            function destroySlider() {
                ...
                function notMobileSlider() {
                    ...
                    if (window.innerWidth >= 992 && slider.dataset.desktop == "true") {
                        destroySwiper = new core(".wherebue__slider", {
                            modules: [ Navigation ],
                            observer: true,
                            observeParents: true,
                            slidesPerView: 2,
                    ...
                    if (window.innerWidth < 992) {
                        ...
                        if (slider.classList.contains("swiper-initialized")) destroySwiper.destroy();
                    }
                }
                notMobileSlider();
            ...
            function pageSlider() {
                ...
                function setScrollType() {
                    if (document.querySelector(".wrapper").classList.contains("_free")) {
                        ...
                        pageSlider.params.sticky.enabled = false;
                    }
                    for (let index = 0; index < pageSlider.slides.length; index++) {
                        ...
                        if (pageSlideContent) {
                            ...
                            if (pageSlideContentHeight > window.innerHeight) {
                                ...
                                pageSlider.params.sticky.enabled = true;
                                break;
                            }
                        }
                    }
